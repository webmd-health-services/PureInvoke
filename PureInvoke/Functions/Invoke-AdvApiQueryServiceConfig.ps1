...
function Invoke-AdvApiQueryServiceConfig
{
    ...
    .DESCRIPTION
    The `Invoke-AdvApiQueryServiceConfig` function calls the Win32 API `QueryServiceConfig` function to retieve a
    ...
    * DisplayName
    ...
    `Invoke-AdvApiOpenService` to get a handle to the service whose configuration you want to get. Pass the service
    handle to `Invoke-AdvApiQueryServiceConfig` to get the service's configuration.
